...
import { saveRegistration, getRegistrations, type FaceRegistration } from '../utils/storage';
...
const StudentRegisterModal: React.FC<StudentRegisterModalProps> = ({ isOpen, onClose, onRegistered }) => {
    ...
    const [registrations, setRegistrations] = useState<FaceRegistration[]>(() => getRegistrations());
    ...
    }, [name, userId, registrations, capturePhoto, department, semester, studentWhatsApp, parentWhatsApp, onRegistered]);
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative bg-slate-900 rounded-xl max-w-3xl w-full p-6 max-h-[90vh] overflow-auto"
            >
                <button
                    onClick={onClose}
                    title="Close"
